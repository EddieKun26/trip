...
- Shopping screenshots are compressed client-side and stored with private shopping records in Redis for this web prototype; leaving or being removed from a trip deletes that member's private shopping record for the trip.
...
- Shopping screenshot OCR also runs locally and supports Traditional Chinese, English, and Japanese. OCR creates editable candidates and never adds an item until the member confirms.
