...
- `node --test tests/*.test.mjs`: 64 tests passing as of 2026-08-12 after raising Shopping imports to twelve, adding honest per-product progress states, retaining concurrent AI recognition, and preserving selected product images.
