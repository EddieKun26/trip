...
- `node --test tests/*.test.mjs`: 57 tests passing as of 2026-08-11 after making the complete social candidate card open its preview and adding stale-deployment protection.
