...
- `node --test tests/*.test.mjs`: 64 tests passing as of 2026-08-12 after removing image generation, adding three web product-image candidates, and adding refresh-with-exclusion behavior.
