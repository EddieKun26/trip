...
- Do not generate product images. Present three web candidates for explicit selection, default to the first, and provide `換一批圖片` when none are satisfactory; later rounds should avoid candidates already shown.
