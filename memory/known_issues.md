...
- Shopping screenshot recognition depends on Vercel AI Gateway availability, configured credits/budgets, and the deployed OIDC credential. Dense or unclear posters can still have low-confidence results, so every recognized field remains editable and requires confirmation.
