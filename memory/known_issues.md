...
- An eight-image import can create up to eight concurrent OpenAI recognition requests. Individual cards may still report rate-limit or temporary network failures independently; successful cards remain editable and failed cards can be retried in a later selection.
