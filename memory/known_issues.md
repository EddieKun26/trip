...
- Private shopping screenshots are compressed reference images stored in Redis for the web prototype. Each member/trip keeps up to 30 recent screenshots; older item text remains but its oldest reference photo can be pruned when the limit is reached.
