...
- First-time shopping screenshot recognition downloads Traditional Chinese, English, and Japanese OCR data and may take longer on mobile networks. Brand, product, benefits, and category are inferred from visible text and product rules, so stylized, low-resolution, or unfamiliar products still require confirmation or correction.
