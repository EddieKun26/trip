...
- Verify that the existing Jingumae, Shinjuku, Jinnan, Azabujuban, Yoyogi, and Asakusa records automatically regroup under Google-resolved Traditional Chinese/local-language headings in a signed-in production trip, then spot-check one Korean and one Latin-script destination.
